...
var apiKey = '49b4d2b86819a6ff4445750c90771072';
...
function getWeather(city) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, temp, description, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (response.ok) {
                        ...
                        weatherResult.innerHTML = "Current weather in ".concat(data.name, ": ").concat(temp, "\u00B0C, ").concat(description);
                    }
                    else {
